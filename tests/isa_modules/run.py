...
def main():
  ...
  paths = ['../../src/simd.x86.ccm', '../../src/simd/attributes.h', '../../etc/cmake/simdProfile.cmake', 'CMakeLists.txt', 'backend.inc', 'consumer.cc', 'dispatcher.cc', 'engine.h', 'fixture.engine.ccm']
