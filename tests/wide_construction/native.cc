...
#if defined(__x86_64__) || defined(_M_X64)
#define NATIVE_TARGET_empty_base "avx2,fma,avx512f,avx512dq"
#define NATIVE_TARGET_empty_bw "avx2,fma,avx512f,avx512dq,avx512bw"
#define NATIVE_TARGET_empty_vl "avx2,fma,avx512f,avx512dq,avx512vl"
#define NATIVE_TARGET_empty_bw_bf16 "avx2,fma,avx512f,avx512dq,avx512bw,avx512bf16"
#define NATIVE_TARGET_empty_bw_fp16 "avx2,fma,avx512f,avx512dq,avx512bw,avx512fp16"
#define NATIVE_TARGET_empty_bw_half "avx2,fma,avx512f,avx512dq,avx512bw,avx512bf16,avx512fp16"
#define NATIVE_TARGET_empty_half "avx2,fma,avx512f,avx512dq,avx512bw,avx512vl,avx512bf16,avx512fp16"
...
#elif defined(__aarch64__) || defined(_M_ARM64)
#define NATIVE_TARGET_empty_half "neon,fullfp16,bf16"
...
#define DEFINE_CASE(name,width) \
  ...
  __attribute__((noinline)) bool construct_##name() { \
    constexpr auto A = NATIVE_TARGET_ISA(name); \
    auto empty=[]<class T>() { \
      static_assert(same_traits<T,0>() && same_traits<T,1>() && same_traits<T,3>()); \
      native::wide<T,0> defaulted; \
      native::wide<T,0> valued{}; \
