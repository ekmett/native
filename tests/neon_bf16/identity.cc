...
static_assert(!addable<native::simd<native::bf16,8,native::neon>,native::simd<native::bf16,8,native::neon>>);
static_assert(complete<native::simd<native::bf16,4,native::neon_bf16>>);
static_assert(!addable<native::simd<native::bf16,4,native::neon_bf16>,native::simd<native::bf16,4,native::neon_bf16>>);
static_assert(complete<native::simd<native::fp16,8,native::neon_bf16>>);
static_assert(!addable<native::simd<native::fp16,8,native::neon_bf16>,native::simd<native::fp16,8,native::neon_bf16>>);
