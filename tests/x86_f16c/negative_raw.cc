...
native_target("f16c") auto rejected(float x) { return native::detail::x86_f16c::cvtss_sh<native::isa<native::x86>{}, 0>(x); }
#elif NATIVE_F16C_REJECT == 2
native_target("f16c") auto rejected(__m128 x) { return native::detail::x86_f16c::cvtps_ph<native::isa<native::x86>(native::x86_feature::avx), 0>(x); }
#elif NATIVE_F16C_REJECT == 3
native_target("f16c") auto rejected(__m256 x) { return native::detail::x86_f16c::cvtps_ph<native::isa<native::x86>{}, 0>(x); }
#elif NATIVE_F16C_REJECT == 4
native_target("f16c") auto rejected(__m128i x) { return native::detail::x86_f16c::cvtph_ps<native::isa<native::x86>{}, 4>(x); }
#elif NATIVE_F16C_REJECT == 5
native_target("f16c") auto rejected(__m128i x) { return native::detail::x86_f16c::cvtph_ps<native::isa<native::x86>{}, 8>(x); }
...
native_target("f16c") auto rejected(std::uint16_t x) { return native::detail::x86_f16c::cvtsh_ss<native::isa<native::x86>{}>(x); }
#else
