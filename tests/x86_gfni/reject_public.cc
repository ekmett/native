...
constexpr auto arch=native::target_features("gfni");
...
constexpr auto arch=native::target_features("avx,gfni");
...
constexpr auto arch=native::target_features("avx512f,gfni");
