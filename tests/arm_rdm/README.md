...
The header, `native.arm.rdm` and `native` variants exercise all thirty-six
...
Qualification: Clang 23.1.1/CMake 4.4.3 on AArch64 macOS passed all seven tests with
