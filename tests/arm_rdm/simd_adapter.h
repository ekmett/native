...
namespace rdm_api {
  template<native::isa<native::arm> Arch> requires requires(int16_t accumulator, int16_t lhs, int16_t rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int16_t accumulator, int16_t lhs, native::simd<std::int16_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int16_t accumulator, int16_t lhs, native::simd<std::int16_t, 8, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int16_t, 4, native::feature_closure(Arch)> accumulator, native::simd<std::int16_t, 4, native::feature_closure(Arch)> lhs, native::simd<std::int16_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int16_t, 8, native::feature_closure(Arch)> accumulator, native::simd<std::int16_t, 8, native::feature_closure(Arch)> lhs, native::simd<std::int16_t, 8, native::feature_closure(Arch)> rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(native::simd<std::int16_t, 8, native::feature_closure(Arch)> accumulator, native::simd<std::int16_t, 8, native::feature_closure(Arch)> lhs, native::simd<std::int16_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(int32_t accumulator, int32_t lhs, int32_t rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  int32_t sqrdmlah(int32_t accumulator, int32_t lhs, int32_t rhs) noexcept {
    return native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs);
  }
  template<native::isa<native::arm> Arch, int Lane> requires requires(int32_t accumulator, int32_t lhs, native::simd<std::int32_t, 2, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int32_t accumulator, int32_t lhs, native::simd<std::int32_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> accumulator, native::simd<std::int32_t, 2, native::feature_closure(Arch)> lhs, native::simd<std::int32_t, 2, native::feature_closure(Arch)> rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> accumulator, native::simd<std::int32_t, 4, native::feature_closure(Arch)> lhs, native::simd<std::int32_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlah<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> accumulator, native::simd<std::int32_t, 4, native::feature_closure(Arch)> lhs, native::simd<std::int32_t, 2, native::feature_closure(Arch)> rhs) { native::sqrdmlah_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(int16_t accumulator, int16_t lhs, int16_t rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int16_t accumulator, int16_t lhs, native::simd<std::int16_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlsh_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int16_t accumulator, int16_t lhs, native::simd<std::int16_t, 8, native::feature_closure(Arch)> rhs) { native::sqrdmlsh_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int16_t, 4, native::feature_closure(Arch)> accumulator, native::simd<std::int16_t, 4, native::feature_closure(Arch)> lhs, native::simd<std::int16_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int16_t, 8, native::feature_closure(Arch)> accumulator, native::simd<std::int16_t, 8, native::feature_closure(Arch)> lhs, native::simd<std::int16_t, 8, native::feature_closure(Arch)> rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(int32_t accumulator, int32_t lhs, int32_t rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  int32_t sqrdmlsh(int32_t accumulator, int32_t lhs, int32_t rhs) noexcept {
    return native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs);
  }
  template<native::isa<native::arm> Arch, int Lane> requires requires(int32_t accumulator, int32_t lhs, native::simd<std::int32_t, 2, native::feature_closure(Arch)> rhs) { native::sqrdmlsh_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane> requires requires(int32_t accumulator, int32_t lhs, native::simd<std::int32_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlsh_lane<native::feature_closure(Arch), Lane>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> accumulator, native::simd<std::int32_t, 2, native::feature_closure(Arch)> lhs, native::simd<std::int32_t, 2, native::feature_closure(Arch)> rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> accumulator, native::simd<std::int32_t, 4, native::feature_closure(Arch)> lhs, native::simd<std::int32_t, 4, native::feature_closure(Arch)> rhs) { native::sqrdmlsh<native::feature_closure(Arch)>(accumulator, lhs, rhs); }
  inline __attribute__((always_inline, target("rdm")))
  ...
  template<native::isa<native::arm> Arch, int Lane, class... A>
