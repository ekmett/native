...
"""Require a successful positive build and six specific rejection diagnostics."""
import argparse
...
parser.add_argument("--kind", choices=("feature", "target"), required=True)
...
for lane in ("d", "q"):
    for prefix in ("", "mask_", "maskz_"):
        name = prefix + "vpopcnt" + lane
...
print(f"Positive control compiled; all six {args.kind} rejections confirmed.")
