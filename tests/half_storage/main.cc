...
#include <cstdio>
#if HALF_REQUIRED_NEON_FP16 || HALF_REQUIRED_NEON
import simd.arm;
#elif HALF_REQUIRED_AVX2 || HALF_REQUIRED_AVX512 || HALF_REQUIRED_AVX512_BF16 || HALF_REQUIRED_AVX512_FP16
import simd.cpuid;
#endif
...
#elif HALF_REQUIRED_AVX512_FP16
  auto profile=simd::x86_profile::avx512_fp16;
...
#endif
#if HALF_REQUIRED_NEON_FP16 || HALF_REQUIRED_NEON || HALF_REQUIRED_AVX2 || HALF_REQUIRED_AVX512 || HALF_REQUIRED_AVX512_BF16 || HALF_REQUIRED_AVX512_FP16
  if(!admission.admitted()) {std::puts(admission.reason());return 77;}
#endif
#if HALF_REQUIRED_AVX512_FP16
