...
#include <cstdint>
#include <cstdio>
constexpr auto partial_arch = simd::feature_closure(simd::avx2 & simd::x86_feature::avx512f & simd::x86_feature::avx512dq);
static_assert(!partial_arch.has(simd::x86_feature::avx512vl));
static_assert(!partial_arch.has(simd::x86_feature::avx512bw));
