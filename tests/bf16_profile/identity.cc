...
static_assert(complete<simd::vec<simd::bf16,8,simd::avx512_bf16>>);
static_assert(complete<simd::vec<simd::bf16,16,simd::avx512_bf16>>);
static_assert(!complete<simd::vec<simd::bf16,4,simd::avx512_bf16>>);
static_assert(!complete<simd::vec<simd::bf16,64,simd::avx512_bf16>>);
...
using bf16x8=simd::vec<simd::bf16,8,simd::avx512_bf16>;
using bf16x16=simd::vec<simd::bf16,16,simd::avx512_bf16>;
static_assert(!has_dot2<bf16x8,bf16x16,simd::vec<float,4,simd::avx512_bf16>>);
static_assert(!has_dot2<bf16x8,bf16x8,simd::vec<float,8,simd::avx512_bf16>>);
static_assert(!has_dot2<bf16x16,bf16x16,simd::vec<float,8,simd::avx512>>);
