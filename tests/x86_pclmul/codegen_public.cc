...
__m128i native_pclmul_legacy_0(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),0>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_1(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),1>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_16(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),16>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_17(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),17>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_238(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),238>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_239(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),239>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_254(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),254>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
extern "C" native_noinline native_target("pclmul")
__m128i native_pclmul_legacy_255(__m128i a, __m128i b) {
  return native::pclmulqdq<native::feature_closure(native::isa(x86_feature::pclmul)),255>(native::simd<std::uint64_t, sizeof(a) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(a), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::feature_closure(native::isa(x86_feature::pclmul))>::from_native(b)).to_native();
}
...
__m128i native_pclmul_evex128_0(__m128i a, __m128i b) {
  ...
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),0>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_1(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),1>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_16(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),16>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_17(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),17>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_238(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),238>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_239(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),239>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_254(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),254>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
__m128i native_pclmul_evex128_255(__m128i a, __m128i b) {
  register __m128i high __asm__("xmm16") = a;
  __asm__("" : "+v"(high));
  return native::vpclmulqdq<native::target_features("avx512f,avx512vl,vpclmulqdq"),255>(native::simd<std::uint64_t, sizeof(high) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(high), native::simd<std::uint64_t, sizeof(b) / sizeof(std::uint64_t), native::target_features("avx512f,avx512vl,vpclmulqdq")>::from_native(b)).to_native();
}
// A high source register prevents LLVM from compressing EVEX to VEX.
extern "C" native_noinline native_target("avx512f,avx512vl,vpclmulqdq")
