...
constexpr native::isa<native::x86> legacy{x86_feature::pclmul};
...
native_target("pclmul") auto rejected(__m128i a, __m128i b, unsigned immediate) {
  return native::detail::x86_pclmul::pclmulqdq<native::isa<native::x86>{},0>(a,b);
}
#elif NATIVE_PCLMUL_REJECT == 2
native_target("avx,pclmul") auto rejected(__m128i a, __m128i b, unsigned immediate) {
  return native::detail::x86_vpclmul::vpclmulqdq<native::isa<native::x86>(x86_feature::avx),0>(a,b);
}
...
native_target("vpclmulqdq") auto rejected(__m256i a, __m256i b, unsigned immediate) {
  return native::detail::x86_vpclmul::vpclmulqdq<native::isa<native::x86>(x86_feature::vpclmulqdq),0>(a,b);
}
#elif NATIVE_PCLMUL_REJECT == 6
native_target("avx512f,vpclmulqdq") auto rejected(__m512i a, __m512i b, unsigned immediate) {
  return native::detail::x86_vpclmul::vpclmulqdq<native::isa<native::x86>(x86_feature::avx512f),0>(a,b);
}
