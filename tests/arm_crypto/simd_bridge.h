...
namespace instruction_fixture {
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::aes))
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::pmull))
  native_nodiscard native_inline native_const native_target("aes")
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::neon))
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::sha1))
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::sha2))
  native_nodiscard native_inline native_const native_target("sha2")
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::sha512))
  ...
  template<native::isa<native::arm> Arch> requires(Arch.has(native::arm_feature::sha3))
  native_nodiscard native_inline native_const native_target("sha3")
  ...
  template<native::isa<native::arm> Arch, unsigned Rotate> requires(Arch.has(native::arm_feature::sha3) && Rotate < 64)
  native_nodiscard native_inline native_const native_target("sha3")
