...
"""Require a successful positive build and every AVX512BITALG boundary diagnostic."""
import argparse
...
parser.add_argument("--kind", choices=("feature", "target", "weak", "shape", "mask"), required=True)
...
count = 0
operations = ["vpopcntb", "mask_vpopcntb", "maskz_vpopcntb",
              "vpopcntw", "mask_vpopcntw", "maskz_vpopcntw",
              "vpshufbitqmb", "mask_vpshufbitqmb"]
