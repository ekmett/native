...
namespace fcma_api {
  ...
  float32x2_t fcadd(float32x2_t a, float32x2_t b) noexcept {
    return vget_low_f32((native::fcadd<native::feature_closure(Arch), Rotation>(native::simd<float, 2, native::feature_closure(Arch)>::from_native(vcombine_f32(a, vdup_n_f32(0))), native::simd<float, 2, native::feature_closure(Arch)>::from_native(vcombine_f32(b, vdup_n_f32(0))))).to_native());
  }
  ...
  float32x2_t fcmla(float32x2_t acc, float32x2_t a, float32x2_t b) noexcept {
    return vget_low_f32((native::fcmla<native::feature_closure(Arch), Rotation>(native::simd<float, 2, native::feature_closure(Arch)>::from_native(vcombine_f32(acc, vdup_n_f32(0))), native::simd<float, 2, native::feature_closure(Arch)>::from_native(vcombine_f32(a, vdup_n_f32(0))), native::simd<float, 2, native::feature_closure(Arch)>::from_native(vcombine_f32(b, vdup_n_f32(0))))).to_native());
  }
