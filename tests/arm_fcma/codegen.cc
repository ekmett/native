...
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcadd_32_2_90(float32x2_t a, float32x2_t b) { return native::fcadd<arch, 90>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcadd_32_2_270(float32x2_t a, float32x2_t b) { return native::fcadd<arch, 270>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcmla_32_2_0(float32x2_t acc, float32x2_t a, float32x2_t b) { return native::fcmla<arch, 0>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcmla_32_2_90(float32x2_t acc, float32x2_t a, float32x2_t b) { return native::fcmla<arch, 90>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcmla_32_2_180(float32x2_t acc, float32x2_t a, float32x2_t b) { return native::fcmla<arch, 180>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x2_t native_fcmla_32_2_270(float32x2_t acc, float32x2_t a, float32x2_t b) { return native::fcmla<arch, 270>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcadd_32_4_90(float32x4_t a, float32x4_t b) { return native::fcadd<arch, 90>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcadd_32_4_270(float32x4_t a, float32x4_t b) { return native::fcadd<arch, 270>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcmla_32_4_0(float32x4_t acc, float32x4_t a, float32x4_t b) { return native::fcmla<arch, 0>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcmla_32_4_90(float32x4_t acc, float32x4_t a, float32x4_t b) { return native::fcmla<arch, 90>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcmla_32_4_180(float32x4_t acc, float32x4_t a, float32x4_t b) { return native::fcmla<arch, 180>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float32x4_t native_fcmla_32_4_270(float32x4_t acc, float32x4_t a, float32x4_t b) { return native::fcmla<arch, 270>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcadd_64_2_90(float64x2_t a, float64x2_t b) { return native::fcadd<arch, 90>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcadd_64_2_270(float64x2_t a, float64x2_t b) { return native::fcadd<arch, 270>(a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcmla_64_2_0(float64x2_t acc, float64x2_t a, float64x2_t b) { return native::fcmla<arch, 0>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcmla_64_2_90(float64x2_t acc, float64x2_t a, float64x2_t b) { return native::fcmla<arch, 90>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcmla_64_2_180(float64x2_t acc, float64x2_t a, float64x2_t b) { return native::fcmla<arch, 180>(acc, a, b); }
extern "C" __attribute__((target("complxnum"), noinline)) float64x2_t native_fcmla_64_2_270(float64x2_t acc, float64x2_t a, float64x2_t b) { return native::fcmla<arch, 270>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcadd_16_4_90(float16x4_t a, float16x4_t b) { return native::fcadd<half_arch, 90>(a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcadd_16_4_270(float16x4_t a, float16x4_t b) { return native::fcadd<half_arch, 270>(a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcmla_16_4_0(float16x4_t acc, float16x4_t a, float16x4_t b) { return native::fcmla<half_arch, 0>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcmla_16_4_90(float16x4_t acc, float16x4_t a, float16x4_t b) { return native::fcmla<half_arch, 90>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcmla_16_4_180(float16x4_t acc, float16x4_t a, float16x4_t b) { return native::fcmla<half_arch, 180>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x4_t native_fcmla_16_4_270(float16x4_t acc, float16x4_t a, float16x4_t b) { return native::fcmla<half_arch, 270>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcadd_16_8_90(float16x8_t a, float16x8_t b) { return native::fcadd<half_arch, 90>(a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcadd_16_8_270(float16x8_t a, float16x8_t b) { return native::fcadd<half_arch, 270>(a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcmla_16_8_0(float16x8_t acc, float16x8_t a, float16x8_t b) { return native::fcmla<half_arch, 0>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcmla_16_8_90(float16x8_t acc, float16x8_t a, float16x8_t b) { return native::fcmla<half_arch, 90>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcmla_16_8_180(float16x8_t acc, float16x8_t a, float16x8_t b) { return native::fcmla<half_arch, 180>(acc, a, b); }
extern "C" __attribute__((target("complxnum,fullfp16"), noinline)) float16x8_t native_fcmla_16_8_270(float16x8_t acc, float16x8_t a, float16x8_t b) { return native::fcmla<half_arch, 270>(acc, a, b); }
