...
namespace scalar_defaults_fixture {
  ...
  static_assert(call_0<std::uint32_t> == (expected.has(native::x86_feature::bmi1)));
  ...
  static_assert(call_1<std::uint32_t> == (expected.has(native::x86_feature::bmi1)));
  ...
  static_assert(call_14<std::uint64_t> == (expected.has(native::x86_feature::bmi1)));
