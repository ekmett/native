...
namespace i8mm_api {
  template<native::isa Arch> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::int8_t, 16, native::feature_closure(Arch)> a, native::simd<std::int8_t, 16, native::feature_closure(Arch)> b) { native::smmla<native::feature_closure(Arch)>(acc, a, b); }
  ...
  template<native::isa Arch> requires requires(native::simd<std::uint32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> a, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> b) { native::ummla<native::feature_closure(Arch)>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> a, native::simd<std::int8_t, 16, native::feature_closure(Arch)> b) { native::usmmla<native::feature_closure(Arch)>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 8, native::feature_closure(Arch)> a, native::simd<std::int8_t, 8, native::feature_closure(Arch)> b) { native::usdot<native::feature_closure(Arch)>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 8, native::feature_closure(Arch)> a, native::simd<std::int8_t, 8, native::feature_closure(Arch)> b) { native::usdot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> acc, native::simd<std::int8_t, 8, native::feature_closure(Arch)> a, native::simd<std::uint8_t, 8, native::feature_closure(Arch)> b) { native::sudot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 8, native::feature_closure(Arch)> a, native::simd<std::int8_t, 16, native::feature_closure(Arch)> b) { native::usdot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 2, native::feature_closure(Arch)> acc, native::simd<std::int8_t, 8, native::feature_closure(Arch)> a, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> b) { native::sudot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> a, native::simd<std::int8_t, 16, native::feature_closure(Arch)> b) { native::usdot<native::feature_closure(Arch)>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> a, native::simd<std::int8_t, 8, native::feature_closure(Arch)> b) { native::usdot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::int8_t, 16, native::feature_closure(Arch)> a, native::simd<std::uint8_t, 8, native::feature_closure(Arch)> b) { native::sudot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  ...
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> a, native::simd<std::int8_t, 16, native::feature_closure(Arch)> b) { native::usdot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
  int32x4_t usdot_lane(int32x4_t acc, uint8x16_t a, int8x16_t b) noexcept {
    return __builtin_bit_cast(int32x4_t, (native::usdot_lane<native::feature_closure(Arch), Lane>(native::simd<std::int32_t, 4, native::feature_closure(Arch)>::from_native(__builtin_bit_cast(typename native::simd<std::int32_t, 4, native::feature_closure(Arch)>::native_type, acc)), native::simd<std::uint8_t, 16, native::feature_closure(Arch)>::from_native(__builtin_bit_cast(typename native::simd<std::uint8_t, 16, native::feature_closure(Arch)>::native_type, a)), native::simd<std::int8_t, 16, native::feature_closure(Arch)>::from_native(__builtin_bit_cast(typename native::simd<std::int8_t, 16, native::feature_closure(Arch)>::native_type, b)))).to_native());
  }
  template<native::isa Arch, unsigned Lane> requires requires(native::simd<std::int32_t, 4, native::feature_closure(Arch)> acc, native::simd<std::int8_t, 16, native::feature_closure(Arch)> a, native::simd<std::uint8_t, 16, native::feature_closure(Arch)> b) { native::sudot_lane<native::feature_closure(Arch), Lane>(acc, a, b); }
  inline __attribute__((always_inline, target("i8mm")))
