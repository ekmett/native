...
namespace simd {
  ...
  inline constexpr std::size_t x86_feature_count=std::size_t(x86_feature::sahf)+1;
  ...
  inline constexpr isa avx2=feature_closure(x86_feature::avx2&x86_feature::fma&x86_feature::bmi2);
