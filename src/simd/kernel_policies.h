...
namespace simd::detail {
  ...
  static_assert([] {
    constexpr std::array targets{
      SIMD_KERNEL_TARGET_17, SIMD_KERNEL_TARGET_9, SIMD_KERNEL_TARGET_13,
      SIMD_KERNEL_TARGET_5, SIMD_KERNEL_TARGET_15, SIMD_KERNEL_TARGET_7,
      SIMD_KERNEL_TARGET_11, SIMD_KERNEL_TARGET_3, SIMD_KERNEL_TARGET_4,
      SIMD_KERNEL_TARGET_2, SIMD_KERNEL_TARGET_1, SIMD_KERNEL_TARGET_23,
      SIMD_KERNEL_TARGET_21, SIMD_KERNEL_TARGET_22, SIMD_KERNEL_TARGET_20,
      SIMD_KERNEL_TARGET_0};
