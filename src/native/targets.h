...
#define NATIVE_BASELINE (\
  ...
  NATIVE_DETAIL_MIN_AES&NATIVE_DETAIL_MIN_SHA&NATIVE_DETAIL_MIN_VAES&NATIVE_DETAIL_MIN_PCLMUL&NATIVE_DETAIL_MIN_VPCLMULQDQ&NATIVE_DETAIL_MIN_CX16&NATIVE_DETAIL_MIN_AVX512CD& \
