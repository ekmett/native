...
export namespace native {
  ...
  template<::native::isa Arch> requires NATIVE_ARCH_REQUIRES(Arch) struct vec<fp16,8,Arch> {
  ...
  native_nodiscard native_inline vec<fp16,8,Arch> fma(
