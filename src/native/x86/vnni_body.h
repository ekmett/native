 ...
 * \{ */
  ...
  constexpr simd<std::int32_t, 4, Arch> dpbusd(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false); }
    else {
  ...
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> mask_dpbusd(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> maskz_dpbusd(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  constexpr simd<std::int32_t, 4, Arch> dpbusds(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> mask_dpbusds(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> maskz_dpbusds(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> mask_dpwssd(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> maskz_dpwssd(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> mask_dpwssds(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 4, Arch> maskz_dpwssds(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> mask_dpbusd(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> maskz_dpbusd(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> mask_dpbusds(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> maskz_dpbusds(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> mask_dpwssd(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> maskz_dpwssd(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> mask_dpwssds(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni,avx512vl")
  constexpr simd<std::int32_t, 8, Arch> maskz_dpwssds(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> mask_dpbusd(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> maskz_dpbusd(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> mask_dpbusds(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> maskz_dpbusds(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> mask_dpwssd(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> maskz_dpwssd(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> mask_dpwssds(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false); }
    else {
  ...
  template<isa<x86> Arch> requires(Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))
  native_nodiscard native_inline native_const native_target("avx512f,avx512vnni")
  constexpr simd<std::int32_t, 16, Arch> maskz_dpwssds(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    if consteval { return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true); }
    else {
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbusd(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> mask_dpbusd(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> maskz_dpbusd(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbusds(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> mask_dpbusds(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> maskz_dpbusds(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }

  /// Evaluate dpwssd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwssd(simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> mask_dpwssd(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> maskz_dpwssd(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwssds(simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> mask_dpwssds(simd<std::int32_t, 4, Arch> accumulator, predicate<4, Arch> mask, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> maskz_dpwssds(predicate<4, Arch> mask, simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbusd(simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> mask_dpbusd(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> maskz_dpbusd(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbusds(simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> mask_dpbusds(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> maskz_dpbusds(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwssd(simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> mask_dpwssd(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> maskz_dpwssd(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnni)) || (!Arch.has(x86_feature::avxvnni) &&
      Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) && Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwssds(simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> mask_dpwssds(simd<std::int32_t, 8, Arch> accumulator, predicate<8, Arch> mask, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni) &&
      Arch.has(x86_feature::avx512vl))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> maskz_dpwssds(predicate<8, Arch> mask, simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }

  /// Evaluate dpbusd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> dpbusd(simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> mask_dpbusd(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> maskz_dpbusd(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> dpbusds(simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> mask_dpbusds(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::uint8_t, 64, Arch>); sizeof(simd<std::int8_t, 64, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> maskz_dpbusds(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::uint8_t, 64, Arch> a, simd<std::int8_t, 64, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }

  /// Evaluate dpwssd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> dpwssd(simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> mask_dpwssd(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> maskz_dpwssd(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, mask.to_bitset(), true);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> dpwssds(simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> mask_dpwssds(simd<std::int32_t, 16, Arch> accumulator, predicate<16, Arch> mask, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avx512f) && Arch.has(x86_feature::avx512vnni))) &&
      requires { sizeof(simd<std::int32_t, 16, Arch>); sizeof(simd<std::int16_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 16, Arch> maskz_dpwssds(predicate<16, Arch> mask, simd<std::int32_t, 16, Arch> accumulator, simd<std::int16_t, 32, Arch> a, simd<std::int16_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, mask.to_bitset(), true);
  }

  /// Evaluate dpbssd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbssd(simd<std::int32_t, 4, Arch> accumulator, simd<std::int8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpbssd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbssd(simd<std::int32_t, 8, Arch> accumulator, simd<std::int8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbssds(simd<std::int32_t, 4, Arch> accumulator, simd<std::int8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbssds(simd<std::int32_t, 8, Arch> accumulator, simd<std::int8_t, 32, Arch> a, simd<std::int8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpbsud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int8_t, 16, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbsud(simd<std::int32_t, 4, Arch> accumulator, simd<std::int8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpbsud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int8_t, 32, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbsud(simd<std::int32_t, 8, Arch> accumulator, simd<std::int8_t, 32, Arch> a, simd<std::uint8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int8_t, 16, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpbsuds(simd<std::int32_t, 4, Arch> accumulator, simd<std::int8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int8_t, 32, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpbsuds(simd<std::int32_t, 8, Arch> accumulator, simd<std::int8_t, 32, Arch> a, simd<std::uint8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpbuud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::uint32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> dpbuud(simd<std::uint32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpbuud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::uint32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 8, Arch> dpbuud(simd<std::uint32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::uint8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::uint32_t, 4, Arch>); sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> dpbuuds(simd<std::uint32_t, 4, Arch> accumulator, simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint8))) &&
      requires { sizeof(simd<std::uint32_t, 8, Arch>); sizeof(simd<std::uint8_t, 32, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 8, Arch> dpbuuds(simd<std::uint32_t, 8, Arch> accumulator, simd<std::uint8_t, 32, Arch> a, simd<std::uint8_t, 32, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwsud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwsud(simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwsud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwsud(simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::uint16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::int16_t, 8, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwsuds(simd<std::int32_t, 4, Arch> accumulator, simd<std::int16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::int16_t, 16, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwsuds(simd<std::int32_t, 8, Arch> accumulator, simd<std::int16_t, 16, Arch> a, simd<std::uint16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwusd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwusd(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwusd at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwusd(simd<std::int32_t, 8, Arch> accumulator, simd<std::uint16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 4, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> dpwusds(simd<std::int32_t, 4, Arch> accumulator, simd<std::uint16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::int32_t, 8, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); sizeof(simd<std::int16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 8, Arch> dpwusds(simd<std::int32_t, 8, Arch> accumulator, simd<std::uint16_t, 16, Arch> a, simd<std::int16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwuud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::uint32_t, 4, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> dpwuud(simd<std::uint32_t, 4, Arch> accumulator, simd<std::uint16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }

  /// Evaluate dpwuud at compile time when its register storage is available.
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::uint32_t, 8, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 8, Arch> dpwuud(simd<std::uint32_t, 8, Arch> accumulator, simd<std::uint16_t, 16, Arch> a, simd<std::uint16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<false>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::uint32_t, 4, Arch>); sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> dpwuuds(simd<std::uint32_t, 4, Arch> accumulator, simd<std::uint16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
  ...
  template<isa<x86> Arch> requires(!((Arch.has(x86_feature::avxvnniint16))) &&
      requires { sizeof(simd<std::uint32_t, 8, Arch>); sizeof(simd<std::uint16_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 8, Arch> dpwuuds(simd<std::uint32_t, 8, Arch> accumulator, simd<std::uint16_t, 16, Arch> a, simd<std::uint16_t, 16, Arch> b) noexcept {
    return detail::x86_instruction_constant::dot<true>(accumulator, a, b, ~std::uint64_t{0}, false);
  }
