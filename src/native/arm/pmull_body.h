...
export namespace native {
  ...
  native_nodiscard native_inline native_const native_target("aes")
  simd<std::uint64_t, 2, Arch> pmull2(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b) noexcept {
  ...
  simd<std::uint16_t, 8, Arch> pmull(simd<std::uint8_t, 8, Arch> a, simd<std::uint8_t, 8, Arch> b) noexcept {
  ...
  template<isa<arm> Arch> requires(Arch.has(arm_feature::neon))
  native_nodiscard native_inline native_const
  simd<std::uint16_t, 8, Arch> pmull2(simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b) noexcept {
