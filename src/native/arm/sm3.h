...
namespace native::detail::arm_sm3 {
  ...
  sm3ss1(uint32x4_t a, uint32x4_t b, uint32x4_t c) noexcept {
  ...
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3tt1a(uint32x4_t state, uint32x4_t ss1, uint32x4_t words) noexcept {
  ...
  template <isa<arm> Arch, int Lane>
    requires(Arch.has(arm_feature::sm3) && Lane >= 0 && Lane < 4)
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3tt1b(uint32x4_t state, uint32x4_t ss1, uint32x4_t words) noexcept {
  ...
  template <isa<arm> Arch, int Lane>
    requires(Arch.has(arm_feature::sm3) && Lane >= 0 && Lane < 4)
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3tt2a(uint32x4_t state, uint32x4_t ss1, uint32x4_t words) noexcept {
  ...
  template <isa<arm> Arch, int Lane>
    requires(Arch.has(arm_feature::sm3) && Lane >= 0 && Lane < 4)
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3tt2b(uint32x4_t state, uint32x4_t ss1, uint32x4_t words) noexcept {
  ...
  template <isa<arm> Arch>
    requires(Arch.has(arm_feature::sm3))
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3partw1(uint32x4_t a, uint32x4_t b, uint32x4_t c) noexcept {
  ...
  template <isa<arm> Arch>
    requires(Arch.has(arm_feature::sm3))
  native_nodiscard native_inline native_const native_target("sm4") uint32x4_t
  sm3partw2(uint32x4_t a, uint32x4_t b, uint32x4_t c) noexcept {
