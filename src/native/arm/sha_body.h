...
export namespace native {
  ...
  template<isa<arm> Arch> requires(Arch.has(arm_feature::sha1))
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha1c(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
    if consteval { return detail::arm_constant::sha1_rounds<0>(abcd, e, wk); }
    else {
  ...
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha1) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha1c(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha1p(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
    if consteval { return detail::arm_constant::sha1_rounds<1>(abcd, e, wk); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha1) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha1p(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha1m(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
    if consteval { return detail::arm_constant::sha1_rounds<2>(abcd, e, wk); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha1) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha1m(simd<std::uint32_t, 4, Arch> abcd, std::uint32_t e, simd<std::uint32_t, 4, Arch> wk) noexcept {
  ...
  template<isa<arm> Arch=NATIVE_BASELINE> requires(Arch.has(arm_feature::sha1))
  native_nodiscard native_inline native_const native_target("sha2")
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha1su0(simd<std::uint32_t, 4, Arch> w0_3, simd<std::uint32_t, 4, Arch> w4_7, simd<std::uint32_t, 4, Arch> w8_11) noexcept {
    if consteval { return detail::arm_constant::sha1su0(w0_3, w4_7, w8_11); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha1) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha1su0(simd<std::uint32_t, 4, Arch> w0_3, simd<std::uint32_t, 4, Arch> w4_7, simd<std::uint32_t, 4, Arch> w8_11) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha1su1(simd<std::uint32_t, 4, Arch> partial, simd<std::uint32_t, 4, Arch> w12_15) noexcept {
    if consteval { return detail::arm_constant::sha1su1(partial, w12_15); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha1) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha1su1(simd<std::uint32_t, 4, Arch> partial, simd<std::uint32_t, 4, Arch> w12_15) noexcept {
    return detail::arm_constant::sha1su1(partial, w12_15);
  }

  /// Return a,b,c,d after four SHA-256 rounds; wk includes round constants.
  template<isa<arm> Arch> requires(Arch.has(arm_feature::sha2))
  native_nodiscard native_inline native_const native_target("sha2")
  constexpr simd<std::uint32_t, 4, Arch> sha256h(simd<std::uint32_t, 4, Arch> abcd, simd<std::uint32_t, 4, Arch> efgh, simd<std::uint32_t, 4, Arch> wk) noexcept {
    if consteval { return detail::arm_constant::sha256_rounds<false>(abcd, efgh, wk); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha2) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha256h(simd<std::uint32_t, 4, Arch> abcd, simd<std::uint32_t, 4, Arch> efgh, simd<std::uint32_t, 4, Arch> wk) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha256h2(simd<std::uint32_t, 4, Arch> efgh, simd<std::uint32_t, 4, Arch> abcd, simd<std::uint32_t, 4, Arch> wk) noexcept {
    if consteval { return detail::arm_constant::sha256_rounds<true>(efgh, abcd, wk); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha2) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha256h2(simd<std::uint32_t, 4, Arch> efgh, simd<std::uint32_t, 4, Arch> abcd, simd<std::uint32_t, 4, Arch> wk) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha256su0(simd<std::uint32_t, 4, Arch> w0_3, simd<std::uint32_t, 4, Arch> w4_7) noexcept {
    if consteval { return detail::arm_constant::sha256su0(w0_3, w4_7); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha2) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha256su0(simd<std::uint32_t, 4, Arch> w0_3, simd<std::uint32_t, 4, Arch> w4_7) noexcept {
  ...
  constexpr simd<std::uint32_t, 4, Arch> sha256su1(simd<std::uint32_t, 4, Arch> partial, simd<std::uint32_t, 4, Arch> w8_11, simd<std::uint32_t, 4, Arch> w12_15) noexcept {
    if consteval { return detail::arm_constant::sha256su1(partial, w8_11, w12_15); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha2) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> sha256su1(simd<std::uint32_t, 4, Arch> partial, simd<std::uint32_t, 4, Arch> w8_11, simd<std::uint32_t, 4, Arch> w12_15) noexcept {
  ...
  template<isa<arm> Arch> requires(Arch.has(arm_feature::sha512))
  ...
  constexpr simd<std::uint64_t, 2, Arch> sha512h(simd<std::uint64_t, 2, Arch> sum, simd<std::uint64_t, 2, Arch> fg, simd<std::uint64_t, 2, Arch> de) noexcept {
    if consteval { return detail::arm_constant::sha512h(sum, fg, de); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha512) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> sha512h(simd<std::uint64_t, 2, Arch> sum, simd<std::uint64_t, 2, Arch> fg, simd<std::uint64_t, 2, Arch> de) noexcept {
  ...
  constexpr simd<std::uint64_t, 2, Arch> sha512h2(simd<std::uint64_t, 2, Arch> sum_ab, simd<std::uint64_t, 2, Arch> c_, simd<std::uint64_t, 2, Arch> ab) noexcept {
    if consteval { return detail::arm_constant::sha512h2(sum_ab, c_, ab); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha512) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> sha512h2(simd<std::uint64_t, 2, Arch> sum_ab, simd<std::uint64_t, 2, Arch> c_, simd<std::uint64_t, 2, Arch> ab) noexcept {
  ...
  constexpr simd<std::uint64_t, 2, Arch> sha512su0(simd<std::uint64_t, 2, Arch> w0_1, simd<std::uint64_t, 2, Arch> w2_) noexcept {
    if consteval { return detail::arm_constant::sha512su0(w0_1, w2_); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha512) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> sha512su0(simd<std::uint64_t, 2, Arch> w0_1, simd<std::uint64_t, 2, Arch> w2_) noexcept {
  ...
  constexpr simd<std::uint64_t, 2, Arch> sha512su1(simd<std::uint64_t, 2, Arch> partial, simd<std::uint64_t, 2, Arch> w14_15, simd<std::uint64_t, 2, Arch> w9_10) noexcept {
    if consteval { return detail::arm_constant::sha512su1(partial, w14_15, w9_10); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha512) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> sha512su1(simd<std::uint64_t, 2, Arch> partial, simd<std::uint64_t, 2, Arch> w14_15, simd<std::uint64_t, 2, Arch> w9_10) noexcept {
    return detail::arm_constant::sha512su1(partial, w14_15, w9_10);
  }

  /// Return a XOR b XOR c for every bit.
  template<isa<arm> Arch> requires(Arch.has(arm_feature::sha3))
  native_nodiscard native_inline native_const native_target("sha3")
  constexpr simd<std::uint8_t, 16, Arch> eor3(simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b, simd<std::uint8_t, 16, Arch> c) noexcept {
    if consteval { return detail::arm_constant::logical<false>(a, b, c); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint8_t, 16, Arch> eor3(simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b, simd<std::uint8_t, 16, Arch> c) noexcept {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::uint16_t, 8, Arch> eor3(simd<std::uint16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b, simd<std::uint16_t, 8, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> eor3(simd<std::uint32_t, 4, Arch> a, simd<std::uint32_t, 4, Arch> b, simd<std::uint32_t, 4, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> eor3(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b, simd<std::uint64_t, 2, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int8_t, 16, Arch> eor3(simd<std::int8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b, simd<std::int8_t, 16, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int16_t, 8, Arch> eor3(simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b, simd<std::int16_t, 8, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> eor3(simd<std::int32_t, 4, Arch> a, simd<std::int32_t, 4, Arch> b, simd<std::int32_t, 4, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::int64_t, 2, Arch> eor3(simd<std::int64_t, 2, Arch> a, simd<std::int64_t, 2, Arch> b, simd<std::int64_t, 2, Arch> c) noexcept {
    return detail::arm_constant::logical<false>(a, b, c);
  }
  ...
  constexpr simd<std::uint8_t, 16, Arch> bcax(simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b, simd<std::uint8_t, 16, Arch> c) noexcept {
    if consteval { return detail::arm_constant::logical<true>(a, b, c); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::uint8_t, 16, Arch> bcax(simd<std::uint8_t, 16, Arch> a, simd<std::uint8_t, 16, Arch> b, simd<std::uint8_t, 16, Arch> c) noexcept {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::uint16_t, 8, Arch> bcax(simd<std::uint16_t, 8, Arch> a, simd<std::uint16_t, 8, Arch> b, simd<std::uint16_t, 8, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::uint32_t, 4, Arch> bcax(simd<std::uint32_t, 4, Arch> a, simd<std::uint32_t, 4, Arch> b, simd<std::uint32_t, 4, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> bcax(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b, simd<std::uint64_t, 2, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int8_t, 16, Arch>); })
  native_nodiscard consteval simd<std::int8_t, 16, Arch> bcax(simd<std::int8_t, 16, Arch> a, simd<std::int8_t, 16, Arch> b, simd<std::int8_t, 16, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int16_t, 8, Arch>); })
  native_nodiscard consteval simd<std::int16_t, 8, Arch> bcax(simd<std::int16_t, 8, Arch> a, simd<std::int16_t, 8, Arch> b, simd<std::int16_t, 8, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int32_t, 4, Arch>); })
  native_nodiscard consteval simd<std::int32_t, 4, Arch> bcax(simd<std::int32_t, 4, Arch> a, simd<std::int32_t, 4, Arch> b, simd<std::int32_t, 4, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::int64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::int64_t, 2, Arch> bcax(simd<std::int64_t, 2, Arch> a, simd<std::int64_t, 2, Arch> b, simd<std::int64_t, 2, Arch> c) noexcept {
    return detail::arm_constant::logical<true>(a, b, c);
  }
  ...
  constexpr simd<std::uint64_t, 2, Arch> rax1(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b) noexcept {
    if consteval { return detail::arm_constant::rax1(a, b); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch> requires(!Arch.has(arm_feature::sha3) && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> rax1(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b) noexcept {
    return detail::arm_constant::rax1(a, b);
  }

  /// Rotate a XOR b right by Rotate bits in each 64-bit lane; Rotate is in [0, 63].
  template<isa<arm> Arch, unsigned Rotate> requires(Arch.has(arm_feature::sha3) && Rotate < 64)
  native_nodiscard native_inline native_const native_target("sha3")
  constexpr simd<std::uint64_t, 2, Arch> xar(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b) noexcept {
    if consteval { return detail::arm_constant::xar<Rotate>(a, b); }
    else {
  ...
  /// Evaluate constant operands without the instruction feature.
  template<isa<arm> Arch, unsigned Rotate> requires(!Arch.has(arm_feature::sha3) && Rotate < 64 && requires { sizeof(simd<std::uint64_t, 2, Arch>); })
  native_nodiscard consteval simd<std::uint64_t, 2, Arch> xar(simd<std::uint64_t, 2, Arch> a, simd<std::uint64_t, 2, Arch> b) noexcept {
  ...
  template<isa<arm> Arch, class... T> void sha1c(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha1p(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha1m(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch=NATIVE_BASELINE, class... T> void sha1h(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha1su0(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha1su1(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha256h(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha256h2(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha256su0(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha256su1(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha512h(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha512h2(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha512su0(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void sha512su1(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void eor3(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void bcax(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, class... T> void rax1(T...) = delete;

  /// Reject unsupported argument shapes or unavailable instruction features.
  template<isa<arm> Arch, unsigned Rotate, class... T> void xar(T...) = delete;
