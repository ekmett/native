...
namespace simd::detail {
  ...
  template<std::size_t... I> struct swizzle {
    ...
    template<class Self> static simd_inline auto words(Self const & self) {
      using T=typename Self::value_type;
    ...
    template<class V> static simd_inline V from_words(swizzle_native<typename V::value_type> words) {
      using T=typename V::value_type;
    ...
    template<class Self>
    simd_nodiscard static simd_inline result<Self> read(Self const & self) {
      using T=typename Self::value_type;
    ...
    template<class Self>
    simd_inline static result<Self> write(Self & self,result<Self> rhs) {
      using T=typename Self::value_type;
...
#define SIMD_SWIZZLE_ROW2(A,I,X,Y,Z,W) \
    ...
    SIMD_SWIZZLE_FIELD(A##Z,2,I,2) SIMD_SWIZZLE_FIELD(A##W,2,I,3)
#define SIMD_SWIZZLE_ROW3(A,I,B,J,X,Y,Z,W) \
    SIMD_SWIZZLE_FIELD(A##B##X,3,I,J,0) SIMD_SWIZZLE_FIELD(A##B##Y,3,I,J,1) \
    SIMD_SWIZZLE_FIELD(A##B##Z,3,I,J,2) SIMD_SWIZZLE_FIELD(A##B##W,3,I,J,3)
#define SIMD_SWIZZLE_PLANE3(A,I,X,Y,Z,W) \
    SIMD_SWIZZLE_ROW3(A,I,X,0,X,Y,Z,W) SIMD_SWIZZLE_ROW3(A,I,Y,1,X,Y,Z,W) \
    SIMD_SWIZZLE_ROW3(A,I,Z,2,X,Y,Z,W) SIMD_SWIZZLE_ROW3(A,I,W,3,X,Y,Z,W)
#define SIMD_SWIZZLE_ROW4(A,I,B,J,C,K,X,Y,Z,W) \
    SIMD_SWIZZLE_FIELD(A##B##C##X,4,I,J,K,0) SIMD_SWIZZLE_FIELD(A##B##C##Y,4,I,J,K,1) \
    SIMD_SWIZZLE_FIELD(A##B##C##Z,4,I,J,K,2) SIMD_SWIZZLE_FIELD(A##B##C##W,4,I,J,K,3)
#define SIMD_SWIZZLE_PLANE4(A,I,B,J,X,Y,Z,W) \
    SIMD_SWIZZLE_ROW4(A,I,B,J,X,0,X,Y,Z,W) SIMD_SWIZZLE_ROW4(A,I,B,J,Y,1,X,Y,Z,W) \
    SIMD_SWIZZLE_ROW4(A,I,B,J,Z,2,X,Y,Z,W) SIMD_SWIZZLE_ROW4(A,I,B,J,W,3,X,Y,Z,W)
#define SIMD_SWIZZLE_CUBE4(A,I,X,Y,Z,W) \
    SIMD_SWIZZLE_PLANE4(A,I,X,0,X,Y,Z,W) SIMD_SWIZZLE_PLANE4(A,I,Y,1,X,Y,Z,W) \
    SIMD_SWIZZLE_PLANE4(A,I,Z,2,X,Y,Z,W) SIMD_SWIZZLE_PLANE4(A,I,W,3,X,Y,Z,W)
#define SIMD_SWIZZLE4(X,Y,Z,W) \
    SIMD_SWIZZLE_FIELD(X,1,0) SIMD_SWIZZLE_FIELD(Y,1,1) SIMD_SWIZZLE_FIELD(Z,1,2) SIMD_SWIZZLE_FIELD(W,1,3) \
    SIMD_SWIZZLE_ROW2(X,0,X,Y,Z,W) SIMD_SWIZZLE_ROW2(Y,1,X,Y,Z,W) SIMD_SWIZZLE_ROW2(Z,2,X,Y,Z,W) SIMD_SWIZZLE_ROW2(W,3,X,Y,Z,W) \
    SIMD_SWIZZLE_PLANE3(X,0,X,Y,Z,W) SIMD_SWIZZLE_PLANE3(Y,1,X,Y,Z,W) SIMD_SWIZZLE_PLANE3(Z,2,X,Y,Z,W) SIMD_SWIZZLE_PLANE3(W,3,X,Y,Z,W) \
    SIMD_SWIZZLE_CUBE4(X,0,X,Y,Z,W) SIMD_SWIZZLE_CUBE4(Y,1,X,Y,Z,W) SIMD_SWIZZLE_CUBE4(Z,2,X,Y,Z,W) SIMD_SWIZZLE_CUBE4(W,3,X,Y,Z,W)
    SIMD_SWIZZLE4(x,y,z,w)
#undef SIMD_SWIZZLE4
#undef SIMD_SWIZZLE_CUBE4
#undef SIMD_SWIZZLE_PLANE4
#undef SIMD_SWIZZLE_ROW4
#undef SIMD_SWIZZLE_PLANE3
#undef SIMD_SWIZZLE_ROW3
#undef SIMD_SWIZZLE_ROW2
#undef SIMD_SWIZZLE_FIELD
  };
}
